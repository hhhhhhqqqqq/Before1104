...
import Message,CaptureQRcode,QRcode,LineFollowing,Debug,maze,Photography
#初始化镜头
sensor.reset()
...
while(True):
    ...
    if Message.Ctr.WorkMode==0: #调试模式
        ...
        if Message.Ctr.TaskMode ==2:
            Photography.photography("1",10)
            Photography.photography("2",10)
            Photography.photography("3",10)
